...
namespace MySQL_Sim
{
    public partial class frmDropView : Form
    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (a == DialogResult.Yes)
                {
                    cn.Open();
                    cmd.Connection = cn;
                    cmd.CommandText = "drop view " + ComboBox2.Text;
                    cmd.ExecuteNonQuery();
                    cmd.Dispose();
                    cn.Close();
                    TextBox1.Text = "drop view " + ComboBox2.Text;
                    MessageBox.Show("View Dropped successfully", "Done", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void frmDropView_Load(object sender, EventArgs e)
        {
            try
            {
